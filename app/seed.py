...
FEDERAL_FORMS = [
    ...
    {"form_number": "1040-ES", "sort_order": 5, "category": "individual", "subcategory": "payment", "title": "Estimated Tax for Individuals",
    ...
    {"form_number": "1040-V", "sort_order": 6, "category": "individual", "subcategory": "payment", "title": "Payment Voucher",
     "description": "Voucher to accompany a check or money order payment made with a paper return.",
     "who_files": "Taxpayer paying by mail", "filing_methods": ["mail"],
     "irs_url": "https://www.irs.gov/forms-pubs/about-form-1040-v",
     "instructions_url": "https://www.irs.gov/forms-pubs/about-form-1040-v"},
    {"form_number": "4868", "sort_order": 7, "category": "individual", "subcategory": "extension", "title": "Application for Automatic Extension of Time to File",
    ...
    {"form_number": "Schedule F", "sort_order": 15, "category": "individual", "subcategory": "income", "title": "Profit or Loss from Farming",
     "description": "Reports income and expenses from farming operations. Net profit is subject to self-employment tax.",
     "who_files": "Farmer or agricultural taxpayer", "filing_methods": ["mail", "efile"],
     "irs_url": "https://www.irs.gov/forms-pubs/about-schedule-f-form-1040",
     "instructions_url": "https://www.irs.gov/instructions/i1040sf"},
    {"form_number": "Schedule H", "sort_order": 16, "category": "individual", "subcategory": "taxes", "title": "Household Employment Taxes",
     "description": "Reports Social Security, Medicare, and federal unemployment taxes owed for household employees (nannies, housekeepers, etc.) paid $2,700+.",
     "who_files": "Taxpayer who employs household workers", "filing_methods": ["mail", "efile"],
     "irs_url": "https://www.irs.gov/forms-pubs/about-schedule-h-form-1040",
     "instructions_url": "https://www.irs.gov/instructions/i1040sh"},
    {"form_number": "Schedule R", "sort_order": 17, "category": "individual", "subcategory": "credit", "title": "Credit for the Elderly or the Disabled",
     "description": "Claims a non-refundable tax credit for taxpayers 65 or older, or permanently disabled, who meet income requirements.",
     "who_files": "Taxpayer age 65+ or permanently disabled", "filing_methods": ["mail", "efile"],
     "irs_url": "https://www.irs.gov/forms-pubs/about-schedule-r-form-1040",
     "instructions_url": "https://www.irs.gov/instructions/i1040sr"},
    {"form_number": "Schedule SE", "sort_order": 18, "category": "individual", "subcategory": "employment", "title": "Self-Employment Tax",
    ...
    {"form_number": "W-4", "sort_order": 21, "category": "individual", "subcategory": "withholding", "title": "Employee's Withholding Certificate",
     "description": "Completed by employees to tell their employer how much federal income tax to withhold. Updated for major life events (marriage, new job, etc.).",
     "who_files": "Employee", "filing_methods": [],
     "irs_url": "https://www.irs.gov/forms-pubs/about-form-w-4",
     "instructions_url": "https://www.irs.gov/instructions/iw4"},
    {"form_number": "W-7", "sort_order": 22, "category": "individual", "subcategory": "id", "title": "Application for IRS Individual Taxpayer Identification Number",
     "description": "Used to apply for an Individual Taxpayer Identification Number (ITIN) by nonresident aliens and others who cannot obtain a Social Security number.",
     "who_files": "Non-U.S. citizen without SSN", "filing_methods": ["mail"],
     "irs_url": "https://www.irs.gov/forms-pubs/about-form-w-7",
     "instructions_url": "https://www.irs.gov/instructions/iw7"},
    {"form_number": "1099-NEC", "sort_order": 23, "category": "informational", "subcategory": "income", "title": "Nonemployee Compensation",
    ...
    {"form_number": "1099-K", "sort_order": 30, "category": "informational", "subcategory": "income", "title": "Payment Card and Third Party Network Transactions",
     "description": "Issued by payment networks (PayPal, Venmo, Etsy, etc.) for business transactions. New 2024 threshold: $5,000+ annually.",
     "who_files": "Payment settlement entity", "provided_by": "Payment processor or platform",
     "filing_methods": [],
     "irs_url": "https://www.irs.gov/forms-pubs/about-form-1099-k",
     "instructions_url": "https://www.irs.gov/instructions/i1099k"},
    {"form_number": "1099-C", "sort_order": 31, "category": "informational", "subcategory": "income", "title": "Cancellation of Debt",
     "description": "Issued when $600+ of debt is cancelled by a lender (e.g. mortgage forgiveness, credit card settlement). Cancelled debt is generally taxable income.",
     "who_files": "Lender or creditor", "provided_by": "Your lender",
     "filing_methods": [],
     "irs_url": "https://www.irs.gov/forms-pubs/about-form-1099-c",
     "instructions_url": "https://www.irs.gov/instructions/i1099ac"},
    {"form_number": "1095-A", "sort_order": 35, "category": "informational", "subcategory": "healthcare", "title": "Health Insurance Marketplace Statement",
    ...
    {"form_number": "1095-B", "sort_order": 36, "category": "informational", "subcategory": "healthcare", "title": "Health Coverage",
     "description": "Issued by insurance companies (not Marketplace) and government agencies reporting that you had minimum essential coverage. Informational — keep for records.",
     "who_files": "Insurance provider or government agency", "provided_by": "Your insurer or employer",
     "filing_methods": [],
     "irs_url": "https://www.irs.gov/forms-pubs/about-form-1095-b",
     "instructions_url": "https://www.irs.gov/instructions/i1095b"},
    {"form_number": "1095-C", "sort_order": 37, "category": "informational", "subcategory": "healthcare", "title": "Employer-Provided Health Insurance Offer and Coverage",
     "description": "Issued by large employers (50+ full-time employees) showing health coverage offered to employees. Required under ACA employer mandate.",
     "who_files": "Applicable large employer (ALE)", "provided_by": "Your employer",
     "filing_methods": [],
     "irs_url": "https://www.irs.gov/forms-pubs/about-form-1095-c",
     "instructions_url": "https://www.irs.gov/instructions/i1095c"},
    # Credits
    ...
    {"form_number": "8606", "sort_order": 92, "category": "individual", "subcategory": "deduction", "title": "Nondeductible IRAs",
     "description": "Reports nondeductible contributions to traditional IRAs, conversions from traditional/SIMPLE/SEP-IRAs to Roth IRAs, and distributions from Roth IRAs.",
     "who_files": "Taxpayer with nondeductible IRA contributions or Roth conversions", "filing_methods": ["mail", "efile"],
     "irs_url": "https://www.irs.gov/forms-pubs/about-form-8606",
     "instructions_url": "https://www.irs.gov/instructions/i8606"},
    # Foreign
    {"form_number": "6251", "sort_order": 105, "category": "individual", "subcategory": "taxes", "title": "Alternative Minimum Tax — Individuals",
     "description": "Calculates Alternative Minimum Tax (AMT) liability. Required for higher-income taxpayers who trigger AMT preferences or adjustments.",
     "who_files": "Taxpayer potentially subject to AMT", "filing_methods": ["mail", "efile"],
     "irs_url": "https://www.irs.gov/forms-pubs/about-form-6251",
     "instructions_url": "https://www.irs.gov/instructions/i6251"},
    {"form_number": "4562", "sort_order": 106, "category": "individual", "subcategory": "deduction", "title": "Depreciation and Amortization",
     "description": "Claims depreciation deductions for business property, Section 179 expensing, and bonus depreciation. Also used to report amortization of intangibles.",
     "who_files": "Taxpayer with business property or vehicles", "filing_methods": ["mail", "efile"],
     "irs_url": "https://www.irs.gov/forms-pubs/about-form-4562",
     "instructions_url": "https://www.irs.gov/instructions/i4562"},
    {"form_number": "2555", "sort_order": 110, "category": "individual", "subcategory": "exclusion", "title": "Foreign Earned Income Exclusion",
    ...
    {"form_number": "8822", "sort_order": 402, "category": "individual", "subcategory": "administrative", "title": "Change of Address",
     "description": "Notifies the IRS of a change of address to ensure correct delivery of notices and refunds.",
     "who_files": "Taxpayer who has moved", "filing_methods": ["mail"],
     "irs_url": "https://www.irs.gov/forms-pubs/about-form-8822",
     "instructions_url": "https://www.irs.gov/forms-pubs/about-form-8822"},
    {"form_number": "8888", "sort_order": 403, "category": "individual", "subcategory": "payment", "title": "Allocation of Refund",
     "description": "Allows splitting a tax refund into up to three financial accounts or purchase of U.S. Savings Bonds.",
     "who_files": "Taxpayer expecting a refund", "filing_methods": ["mail", "efile"],
     "irs_url": "https://www.irs.gov/forms-pubs/about-form-8888",
     "instructions_url": "https://www.irs.gov/instructions/i8888"},
    {"form_number": "SS-4", "sort_order": 220, "category": "business", "subcategory": "id", "title": "Application for Employer Identification Number (EIN)",
     "description": "Used to obtain a federal Employer Identification Number for businesses, trusts, estates, and other entities.",
     "who_files": "New business entity", "filing_methods": ["mail", "efile"],
     "irs_url": "https://www.irs.gov/forms-pubs/about-form-ss-4",
     "instructions_url": "https://www.irs.gov/instructions/iss4"},
]
