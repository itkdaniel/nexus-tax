    ...
    async def info():
        ...
        return InfoResponse(
            ...
            endpoints=[
                ...
                {"method": "GET",  "path": "/v1/forms/federal",                "auth": False, "description": "List federal forms"},
                {"method": "GET",  "path": "/v1/forms/federal/{form_number}",  "auth": False, "description": "Get federal form by number"},
                {"method": "GET",  "path": "/v1/forms/state",                  "auth": False, "description": "List all state forms"},
                {"method": "GET",  "path": "/v1/forms/state/{state_code}",     "auth": False, "description": "Get state forms by state code"},
                {"method": "GET",  "path": "/v1/rates/{year}",                 "auth": False, "description": "Full rate bundle for a year"},
                {"method": "GET",  "path": "/v1/rates/{year}/brackets",        "auth": False, "description": "Tax brackets for a year"},
                {"method": "GET",  "path": "/v1/rates/{year}/deductions",      "auth": False, "description": "Standard deductions for a year"},
                {"method": "GET",  "path": "/v1/rates/{year}/special",         "auth": False, "description": "Special tax rates for a year"},
                {"method": "POST", "path": "/v1/calculate",                    "auth": False, "description": "Calculate federal income tax"},
                {"method": "GET",  "path": "/v1/questions",                    "auth": False, "description": "List questionnaire questions"},
                {"method": "POST", "path": "/v1/sessions",                     "auth": False, "description": "Start a new questionnaire session"},
                {"method": "GET",  "path": "/v1/sessions/{id}",                "auth": False, "description": "Get session state"},
                {"method": "PATCH","path": "/v1/sessions/{id}/answers",        "auth": False, "description": "Save answers progressively"},
                {"method": "POST", "path": "/v1/sessions/{id}/complete",       "auth": False, "description": "Compute required forms, mark complete"},
                {"method": "GET",  "path": "/v1/periods",                      "auth": False, "description": "List all tax periods"},
                {"method": "POST", "path": "/v1/admin/seed-year",              "auth": True,  "description": "Manual seed trigger (admin)"},
            ],
        )
